...
const FacultyLayout = ({ children }) => {
  ...
  const navItems = [
    ...
    { label: "Alumni Approvals", path: "/faculty/alumni-approvals", icon: "🛡️" },
    { label: "Students", path: "/faculty/students", icon: "🎓" },
    { label: "Alumni Directory", path: "/faculty/alumni", icon: "💼" },
    { label: "Recommend Mentor", path: "/faculty/recommend-mentor", icon: "⭐" },
    { label: "Announcements", path: "/faculty/announcements", icon: "📢" },
    { label: "Manage Events", path: "/faculty/manage-events", icon: "📅" },
    { label: "Faculty Profile", path: "/faculty/profile", icon: "👤" },
  ];
    ...
    <div style={styles.wrapper}>
      ...
      <header style={styles.topbar}>
        <div style={styles.topbarInner}>
          <Link to="/faculty/dashboard" style={styles.logo}>
            <img
            ...
            <div style={styles.titleBox}>
              ...
              <span style={styles.portalHead}>
                AlumniConnect <span style={styles.roleTag}>Faculty Portal</span>
              </span>
            </div>
          </Link>
